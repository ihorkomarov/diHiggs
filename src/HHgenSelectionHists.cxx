...
HHgenSelectionHists::HHgenSelectionHists(Context & ctx, const string & dirname): Hists(ctx, dirname){
...
void HHgenSelectionHists::fill(const Event & event){
...
HHgenSelectionHists::~HHgenSelectionHists(){}
